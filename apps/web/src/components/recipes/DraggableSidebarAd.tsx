...
export default function DraggableSidebarAd() {
  ...
  return (
    <motion.div
      ...
      className="relative rounded-[32px] overflow-hidden border border-border/50 group aspect-[4/3] shadow-xl cursor-grab z-40 bg-card"
    >
      <div className="pointer-events-none w-full h-full absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-black/20 p-6 flex flex-col justify-between">
          ...
          <div>
            <h4 className="font-black text-xl text-white tracking-tight mb-1">Premium Cookware</h4>
            <p className="text-[10px] text-white/70 font-medium mb-4">Built for passion. Designed to last.</p>
