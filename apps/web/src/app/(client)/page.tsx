  ...
  return (
    <div className="w-full bg-background text-foreground pb-0 sm:pb-6">
      ...
      <section className="relative w-full h-[25vh] min-h-[180px] sm:h-[45vh] sm:min-h-[300px] border-b border-white/5 mb-8 sm:mb-16 bg-black">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-start justify-start text-left px-6 sm:px-16 md:px-24 pt-6 sm:pt-12 md:pt-16 bg-gradient-to-br from-black/60 via-black/20 to-transparent pointer-events-none">
